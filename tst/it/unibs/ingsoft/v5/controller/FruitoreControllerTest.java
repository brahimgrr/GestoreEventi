...
import it.unibs.ingsoft.v5.model.*; import it.unibs.ingsoft.v5.persistence.AppData; import it.unibs.ingsoft.v5.persistence.IPersistenceService;
...
@DisplayName("V5 – FruitoreController") class FruitoreControllerTest { private FruitoreService frs; private PropostaService ps; private CategoriaService cs; private IscrizioneService is;
