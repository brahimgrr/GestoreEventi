...
public final class ScriptedAppView implements IAppView {
    ...
    private final List<Map<String, List<String>>> printedCategoryDetails = new ArrayList<>();
    ...
    public List<Map<String, List<String>>> getPrintedCategoryDetails() {
        return Collections.unmodifiableList(printedCategoryDetails);
    }
    ...
    public void stampaCategorieDettaglio(Map<String, List<String>> categorieConCampi) {
        printedCategoryDetails.add(categorieConCampi);
