...
import it.unibs.ingsoft.v4.model.Fruitore; import it.unibs.ingsoft.v4.persistence.AppData; import it.unibs.ingsoft.v4.persistence.IPersistenceService;
...
@DisplayName("V4 – FruitoreService") class FruitoreServiceTest { private FruitoreService fs;
...
@Test @DisplayName("Duplicate throws") void d() { fs.registraFruitore("user1", "pass1234"); assertThrows(IllegalArgumentException.class, () -> fs.registraFruitore("user1", "x")); } }
