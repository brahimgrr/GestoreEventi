...
import it.unibs.ingsoft.v3.persistence.*;
...
public final class App
{
    ...
    {
        ICategoriaRepository catRepo      = new FileCategoriaRepository(Path.of("data", "v3_catalogo.ser"));
        IUtenteRepository    utenteRepo   = new FileUtenteRepository(Path.of("data", "v3_utenti.ser"));
        IFruitoreRepository  fruitoreRepo = new FileFruitoreRepository(Path.of("data", "v3_fruitori.ser"));
        INotificaRepository  notificaRepo = new FileNotificaRepository(Path.of("data", "v3_notifiche.ser"));
        IPropostaRepository  propostaRepo = new FilePropostaRepository(Path.of("data", "v3_proposte.ser"));
