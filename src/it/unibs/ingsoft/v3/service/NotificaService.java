...
public final class NotificaService
{
     ...
     * The caller is responsible for calling {@code db.save(data)} after all
     ...
     * @pre username != null
     * @pre messaggio != null
     * @post getNotifiche(username) contains a new Notifica with the given message
     */
     ...
     *
     * @pre username != null
     * @return unmodifiable list of notifications; empty list if none
     */
     ...
     * @post getNotifiche(username).size() is decreased by 1
