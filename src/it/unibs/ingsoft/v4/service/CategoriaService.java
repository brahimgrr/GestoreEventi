...
public final class CategoriaService
{
     ...
     * @pre tipoDato != null
     * @throws IllegalArgumentException if name conflicts with an existing field
     */
     ...
     * @throws IllegalArgumentException if categoria already exists
     */
     ...
     * @pre tipoDato != null
     * @throws IllegalArgumentException if name conflicts exist or categoria not found
     */
