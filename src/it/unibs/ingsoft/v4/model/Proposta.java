...
public class Proposta implements Serializable
{
    ...
    {
        if (stato == null) throw new IllegalArgumentException("Lo stato non può essere null.");
        if (data  == null) throw new IllegalArgumentException("La data non può essere null.");
