...
public final class ConsoleUI implements IAppView
{
    ...
    /**
     * Mostra la bacheca delle proposte aperte, raggruppate per categoria.
     *
     * @param bacheca        mappa categoria → lista proposte
     * @param campiProvider  funzione che, data una Proposta, restituisce i campi (base+comuni+specifici)
     */
