...
public class PropostaService
{
     ...
     * @pre  the category named {@code nomeCategoria} exists in the data store
     * @post the returned proposal has stato == StatoProposta.BOZZA
     * @post the returned proposal is NOT yet saved (call pubblicaProposta to persist)
     * @param nomeCategoria the name of the category
     * @return the new unsaved proposal
