...
import it.unibs.ingsoft.v2.model.AppConstants;
...
import it.unibs.ingsoft.v2.model.TipoDato;
import it.unibs.ingsoft.v2.service.CategoriaService;
import it.unibs.ingsoft.v2.service.PropostaService;
import it.unibs.ingsoft.v2.view.FieldValidator;
import it.unibs.ingsoft.v2.view.FormField;
import it.unibs.ingsoft.v2.view.IAppView;
import it.unibs.ingsoft.v2.view.StepByStepFormRunner;
 ...
 * Delegates business operations to services; UI interactions to IAppView.
 */
public final class ConfiguratoreController
{
    ...
    public ConfiguratoreController(IAppView ui, CategoriaService cs, PropostaService ps)
    {
        this.ui = ui;
        this.cs = cs;
        this.ps = ps;
    ...
    private void menuCreaProposta()
    {
        ...
        catch (it.unibs.ingsoft.v2.view.ConsoleUI.CancelException e)
        {
